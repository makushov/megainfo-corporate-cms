...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
 	<?php $this->include_tpl('language/jsLangsDefine.tpl', '/Applications/MAMP/htdocs/imagecms/templates/corporate'); ?>
        <?php $this->include_tpl('language/jsLangs.tpl', '/Applications/MAMP/htdocs/imagecms/templates/corporate'); ?>
        <div class="main-body">
                ...
                <header>
                    <div class="menu-header">
                        <div class="container">
                            ...
                            <?php $this->include_tpl('auth_data', '/Applications/MAMP/htdocs/imagecms/templates/corporate'); ?>
                        </div>
                    </div>
...
<?php $mabilis_ttl=1425720900; $mabilis_last_modified=1425473714; ///Applications/MAMP/htdocs/imagecms/templates/corporate/main.tpl ?>